...
class Server():
    ...
    async def connect(self, serveruri = SERVER_URI):
        self.client = MongoClient("mongodb+srv://namjp:Nam18.08.2007@mongoserver-ayayabot.yjpfd6k.mongodb.net/?retryWrites=true&w=majority&appName=MONGOSERVER-ayayabot")
